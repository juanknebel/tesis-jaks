...
Lo que se propone con este nuevo tipo de búsquedas es otorgarle al usuario conjuntos (o bundles) de 
resultados forma organizada y en el cuál cada bundle contenga elementos (del mismo tipo o no) que 
se encuentran relacionado por algún atributo definido y además no se repitan elementos dentro del 
mismo. Además de cada bundle sea independiente del resto.\\
