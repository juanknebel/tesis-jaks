...
De todos los algorimos descriptos en las secciones anteriores las pruebas realizadas fueron usando {EfficientHAC}, \texttt{Búsqueda Local} y \texttt{BOBO} y al terminar su ejecución se aplicó una búsqueda Tabú para intentar mejorar la solución obtenida.\\
\Solucion
{}
{\texttt{EfficientHAC}, \texttt{Búsqueda Local} y \texttt{BOBO}}
