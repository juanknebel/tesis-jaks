...
En esta búsqueda se destaca la búsqueda tabú, principalmente aplicada a la solución obtenida a partir de $alg5$, ya que la solución generada a partir de todos los gammas alcanzó la cota máxima (su función objetivo) para el presupueso encontrada en ...... \myworries{poner la referencia}
