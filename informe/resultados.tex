...
{
\begin{description}
	\item[alg\_1] \texttt{PAC(BOBO-100/Selección de bundles)}
	\item[alg\_2] \texttt{PAC(BOBO-100/Selección de bundles proporcional)}
	\item[alg\_3] \texttt{PAC(Efficient C-HAC/Selección de bundles)}
	\item[alg\_4] \texttt{PAC(Efficient C-HAC/Selección de bundles proporcional)}
	\item[alg\_5] \texttt{Búsqueda Golosa}
\end{description}
}
{$(0,1; 0,3; 0,5; 0,7; 0,9)$}
{10}
...
{Denset Subgraph, Proportional (no aplican a la búsqueda golosa)}
...
{}
{\texttt{SingleHAC}, \texttt{Búsqueda Golosa} y \texttt{BOBO-100}}
{Denset Subgraph, Proportional (no aplica a la búsqueda golosa)}
{$\in$ $(0,1; 0,3; 0,5; 0,7; 0,9)$}
{10}
{5}
...
\SolucionBudget
{}
{\texttt{Goloso}, \texttt{PAC(SingleHAC},  y \texttt{BOBO-100}}
{Denset Subgraph, Proportional (no aplica a la búsqueda golosa)}
{$\in$ $(0,1; 0,3; 0,5; 0,7; 0,9)$}
{10}
{3}
