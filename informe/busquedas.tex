Las búsquedas sobre la base de datos se concibieron a partir de lo que se consideró interesante para el público en general y de cierta complejidad para que el valor teórico de este trabajo.\\
