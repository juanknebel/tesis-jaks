...
Los algoritmos golosos son aquellos que utilizan una heurística para resolver un problema, ésta misma consiste en cada paso elegir la opción óptima esperando asi lograr al la solución óptima al final de la ejecución. No siempre encuentra la solución pero son muy usados por su sencillez y velocidad a la hora de su ejecutarse.\\
