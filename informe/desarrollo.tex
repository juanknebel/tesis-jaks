El algoritmo que se utilizó para obtener las soluciones es \tenxttt{Produce-and-Choose}, cuenta con dos fases.
En la primer fase se generar cierta cantidad de bundles, e la fase siguiente se seleccionan los bundles que
...
Se realizaron soluciones con dos funciones de distancia diferentes. La primer función utilizada d1(u,v) = 1 - s(u, v).
La función d1 no tiene en cuenta el gamma, para obtener soluciones de bundles más diversos o bundles más cohesivos.
La función d2(u,v) = 1 - fn obj(u,v) tiene en cuenta el gamma para buscar una mejor solución.

En la figura se ve la diferencia de utilizar d1 y d2
