...
Se implemento un algoritmo de cada categoria. Del método jerárquico se desarrolló el algoritmo Hierarchical clustering. Mientras que para el método de partición el algoritmo Bundles One-By-One.\\
