...
La búsqueda se concebío especialmente para la fase de selección del algoritmo \texttt{Produce-and-Choose}. En esta fase se eligen los bundles que pertencen a la solución. De la solución obtenida se realiza la búsqueda tabú con los bundles generados en la fase del produce.\\
Los movEl movimiento de la solución $S$ a la solución $S'$ consiste de los siguientes  pasos:
\begin{enumerate}
