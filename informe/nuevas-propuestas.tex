...
Como mencionamos en la \autoref{introduccion:problemaFormal}, los parámetros del algoritmo son: el conjunto de ítems $I$, el atributo complementario $\alpha$, la función de presupuesto $f: 2^{I} \rightarrow \rm I \!R$, el límite del presupuesto $\beta$, un valor $0 < \gamma < 1\ \in \rm I \!R$ (para ponderar si se quiere paquetes más cohesivos frente a mayor diversidad) y una cantidad $k$ de paquetes a generar. 
