...
En \cite{journals/tkde/Amer-YahiaBCFMZ14} se propone utilizar la heurística \ref{alg:chooseBundles} para hallar el k-subgrafo de mayor peso de un grafo ponderado. El algoritmo consiste en remover en cada iteración uno del par de nodos del vértice con menor peso del grafo hasta que quedarse con un grafo de $k$ nodos.
...
Un algoritmo goloso es un tipo de heurística que construye la solución iterativamente seleccionando en cada paso la opción óptima local, esperando así lograr una solución de suma calidad al finalizar la ejecución. No siempre encuentra la solución óptima pero son muy usados por su sencillez y ve
locidad de la ejecución.
