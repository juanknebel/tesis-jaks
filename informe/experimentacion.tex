...
A continuación se describirá para cada consulta, realizada sobre las bases de datos, cuales fueron: la función de similitud, el atributo utilizado para definir la complementaridad de los elementos y el presupuesto, elegidos para las instancias escogidas. 
