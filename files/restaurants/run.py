...
cmdGamma01 = './tesis-jaks --option 1 --algorithms RandomBOBO --strategy RANK_BY_INTRA_INTER_PROPORTIONAL --element FILE --bundles 10 --budget 30.0 --gamma 0.9 --directory ./ --write 1'
cmdGamma05 = './tesis-jaks --option 1 --algorithms RandomBOBO --strategy RANK_BY_INTRA_INTER_PROPORTIONAL --element FILE --bundles 10 --budget 30.0 --gamma 0.5 --directory ./ --write 1'
cmdGamma09 = './tesis-jaks --option 1 --algorithms RandomBOBO --strategy RANK_BY_INTRA_INTER_PROPORTIONAL --element FILE --bundles 10 --budget 30.0 --gamma 0.1 --directory ./ --write 1'
cmdGamma01BS = './tesis-jaks --option 1 --algorithms RandomBOBO --strategy RANK_BY_DENSEST_SUBGRAPH --element FILE --bundles 10 --budget 30.0 --gamma 0.9 --directory ./ --write 1'
cmdGamma05BS = './tesis-jaks --option 1 --algorithms RandomBOBO --strategy RANK_BY_DENSEST_SUBGRAPH --element FILE --bundles 10 --budget 30.0 --gamma 0.5 --directory ./ --write 1'
cmdGamma09BS = './tesis-jaks --option 1 --algorithms RandomBOBO --strategy RANK_BY_DENSEST_SUBGRAPH --element FILE --bundles 10 --budget 30.0 --gamma 0.1 --directory ./ --write 1'
cmdGamma01EHP = './tesis-jaks --option 1 --algorithms EfficientHAC --strategy RANK_BY_INTRA_INTER_PROPORTIONAL --element FILE --bundles 10 --budget 30.0 --gamma 0.9 --directory ./ --write 1'
cmdGamma05EHP = './tesis-jaks --option 1 --algorithms EfficientHAC --strategy RANK_BY_INTRA_INTER_PROPORTIONAL --element FILE --bundles 10 --budget 30.0 --gamma 0.5 --directory ./ --write 1'
cmdGamma09EHP = './tesis-jaks --option 1 --algorithms EfficientHAC --strategy RANK_BY_INTRA_INTER_PROPORTIONAL --element FILE --bundles 10 --budget 30.0 --gamma 0.1 --directory ./ --write 1'
cmdGamma01EAS = './tesis-jaks --option 1 --algorithms EfficientHAC --strategy RANK_BY_DENSEST_SUBGRAPH --element FILE --bundles 10 --budget 30.0 --gamma 0.9 --directory ./ --write 1'
cmdGamma05EAS = './tesis-jaks --option 1 --algorithms EfficientHAC --strategy RANK_BY_DENSEST_SUBGRAPH --element FILE --bundles 10 --budget 30.0 --gamma 0.5 --directory ./ --write 1'
cmdGamma09EAS = './tesis-jaks --option 1 --algorithms EfficientHAC --strategy RANK_BY_DENSEST_SUBGRAPH --element FILE --bundles 10 --budget 30.0 --gamma 0.1 --directory ./ --write 1'
cmdGamma01HS = './tesis-jaks --option 1 --algorithms RestrictedHAC --strategy RANK_BY_DENSEST_SUBGRAPH --element FILE --bundles 10 --budget 30.0 --gamma 0.9 --directory ./ --write 1'
cmdGamma05HS = './tesis-jaks --option 1 --algorithms RestrictedHAC --strategy RANK_BY_DENSEST_SUBGRAPH --element FILE --bundles 10 --budget 30.0 --gamma 0.5 --directory ./ --write 1'
cmdGamma09HS = './tesis-jaks --option 1 --algorithms RestrictedHAC --strategy RANK_BY_DENSEST_SUBGRAPH --element FILE --bundles 10 --budget 30.0 --gamma 0.1 --directory ./ --write 1'
