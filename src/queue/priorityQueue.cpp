...
int PriorityQueue::push(std::tuple<int, double> element) {
    int key = this->nextKey;
    this->theQueue_->push(std::tuple<int,std::tuple<int, double>>(key, element));
