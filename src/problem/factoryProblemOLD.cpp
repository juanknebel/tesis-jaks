#include "factoryProblemOLD.h"

FactoryProblemOLD::FactoryProblemOLD()
{
}

ProblemInstance* FactoryProblemOLD::getTheProblemInstance(ConfigurationJaks& configFile)
{
...
ProblemInstance* FactoryProblemOLD::getTheProblemInstance(ConfigurationJaks &configFile, Dao* dao)
{
