/**
 * http://retis.sssup.it/~scordino/code/logger.html
 **/
 ...
 * \brief Macro to print log messages.
 * Example of usage of the Logger:
 *	    DEBUG_NO_ERROR(DBG_DEBUG, "hello " << "world");
 */
#define DEBUG_NO_ERROR(priority, msg) { \
	std::ostringstream __debug_stream__; \
	__debug_stream__ << msg; \
	Logger::getInstance().printWithNoError(priority, __FILE__, __LINE__, \
			__debug_stream__.str()); \
	}
