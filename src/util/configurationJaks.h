...
/* Ejemplo de un archivo de configuracion
	...
	DIRECTORY_WORK	/home/zero/Projects/tesis-jaks/files/
	...
	MAX_TRIALS	10
	#Valor del budget (o presupuesto)
	BUDGET	10.80
	...
	#SequentialScanSolver = 7
	SOLVER	3
	#Inicilizar el log
	LOG	0
	#Ejecutar con un item similar en todos: 1 para si, 0 para no
	WITH_SPECIFIC_TEM	1
	#El elemento especifico
	SPECIFIC_ITEM	7
 */
