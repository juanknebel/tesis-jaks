...
\begin{itemize}
	...
	\textcolor{cyan}{Los años representados en los paquetes sean representativos}.
\end{itemize}
}
...
Una propuesta completamente diferente al resto de las mencionadas:
\begin{itemize}
	\item Propuesta completamente diferente al resto.
	\item Comienza con $k$ clusters vacíos.
	\item En cada iteración agrega un ítem al cluster que maximice la función objetivo sin importar que el nuevo valor sea menor al actual.
	\item El algoritmo va a generar soluciones en las que se prioriza completar los paquetes con la máxima cantidad de ítems.
\end{itemize}
}
