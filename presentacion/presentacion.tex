...
\begin{itemize}
	...
	$$b_{r} = \argmin_{b_{j} \in \overline{S}} \sum_{\substack{b_{j} \in \overline{S}\\ b_{j} \neq b_{i}}} (1 - \max_{\substack{u \in b_{i}\\ v \in b_{j}}}s(u,v))$$
	\item Identifica el paquete $b_{c}$ con menor valor en $S \setminus \{b_{r}\}$.
...
\begin{itemize}
	...
	\item Como primer medida intenta agregar un ítem $r$ de $C$ al paquete si es posible para aprovechar el presupuesto.
	...
	\item Evalúa la solución reemplazando $b$ por $b \setminus \{i\}$ antes de terminar la iteración.
...
\begin{itemize}
	...
	\item Función de similitud comparar el perfil de cada autor.
	\item Atributo de complementariedad definido como la afiliación del autor.
	\item Una unidad de costo de cada artículo o autor y cinco de presupuesto $\beta$ (todos los paquetes contendrán como máximo cinco artículos o autores).
...
\begin{table}[H]
\begin{center}
\caption{Comparación de calidad de soluciones entre algoritmos para la búsqueda de artículos}
\scalebox{0.7}{
\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
\hline
$\gamma$&\textcolor{cyan}{$HACS$}&\textcolor{cyan}{$BOBS$}&$BOBP$&$BOBP+T$&$HACP$&$HACP+T$&$GOL$&$GOL+T$ \\ \hline
...
\begin{figure}[H]
	\includegraphics[width=0.60\linewidth]{imagenes/gamma-01-alg-3.png}
\end{figure}
}

\frame{\frametitle{$BOBP+T\ \gamma = 0,1$}
\begin{figure}[H]
	\includegraphics[width=0.60\linewidth]{imagenes/gamma-01-alg-4.png}
\end{figure}
}

\frame{\frametitle{$BOBO\ \gamma = 0,9$}
\begin{figure}[H]
	\includegraphics[width=0.60\linewidth]{imagenes/gamma-09-alg-3.png}
\end{figure}
}

\frame{\frametitle{$BOBP+T\ \gamma = 0,9$}
\begin{figure}[H]
	\includegraphics[width=0.60\linewidth]{imagenes/gamma-09-alg-4.png}
\end{figure}
}
