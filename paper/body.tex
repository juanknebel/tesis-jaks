...
\texttt{Composite Retrieval of Diverse and Complementary Bundles} es el artículo que propone esta forma de devolver los resultados. En el mismo se sugieren diferentes algoritmos para hallar una solución, entre ellos se encuentra Produce and Choose que consiste primero en generar bundles que cumplan con las condiciones indicadas y como último paso seleccionar los mejores que formarán parte de la solución.\\ 
En el artículo para la fase de producción uno de los algoritmos utilizados es la clusterización jerárquica que más adelante se explicará con más detalle y será comparado con las mejoras propuestas en este trabajo.
